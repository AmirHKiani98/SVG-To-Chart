        ...
        r.exports = function(r, e) {
            ...
            if (s)
                for (t in e) {
                    if (
                        ((o = e[t]),
                            (n = r.noTargetGet ? (a = p(s, t)) && a.value : s[t]), !m(c ? t : i + (u ? '.' : '#') + t, r.forced) && void 0 !== n)
                    ) {
        ...
        function n(c) {
            return function(r, e, t) {
                ...
                if (c && e != e) {
                    ...
                    for (; i < a; i++)
                        if ((c || i in o) && o[i] === e) return c || i || 0;
                return !c && -1;
            };
        }
        var u = t(12),
            ...
            return function(r, e, t, n) {
                for (
                    var o,
                        ...
                        l = 0,
                        p = n || S,
                        f = g ? p(r, s) : h ? p(r, 0) : void 0; l < s; l++
                )
        ...
        a(
            ...
            function() {
                var r,
                    ...
                    t = e.string,
                    n = e.index;
                return n >= t.length ? { value: void 0, done: !0 } :
